...
## 4. Bedah Anatomi Tiga Pohon Berdasarkan Kasta Taksonomi

Ini adalah rontgen arsitektur level *Hardcore*. Kita membedah bagaimana 3 Kasta UI (Layout, Gravitasi, Atom) memiliki bentuk tulang punggung yang **berbeda total** saat mereka turun ke level `Element` dan `RenderObject`.

### A. Anatomi Kasta Pengatur Ruang (Layout)
